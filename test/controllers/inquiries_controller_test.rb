...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference("Inquiry.count") do
      post inquiries_url, params: { inquiry: { email_address: @inquiry.email_address, message: @inquiry.message, name: @inquiry.name, phone_number: @inquiry.phone_number } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { email_address: @inquiry.email_address, message: @inquiry.message, name: @inquiry.name, phone_number: @inquiry.phone_number } }
